...
class SpecialitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post specialities_url, params: { speciality: { description: @speciality.description, id_user_mod: @speciality.id_user_mod, id_user_reg: @speciality.id_user_reg, name: @speciality.name } }
    end
  ...
  test "should update speciality" do
    patch speciality_url(@speciality), params: { speciality: { description: @speciality.description, id_user_mod: @speciality.id_user_mod, id_user_reg: @speciality.id_user_reg, name: @speciality.name } }
