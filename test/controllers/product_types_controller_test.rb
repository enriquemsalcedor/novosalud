...
class ProductTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post product_types_url, params: { product_type: { description: @product_type.description, id_user_mod: @product_type.id_user_mod, id_user_reg: @product_type.id_user_reg, name: @product_type.name } }
    end
  ...
  test "should update product_type" do
    patch product_type_url(@product_type), params: { product_type: { description: @product_type.description, id_user_mod: @product_type.id_user_mod, id_user_reg: @product_type.id_user_reg, name: @product_type.name } }
