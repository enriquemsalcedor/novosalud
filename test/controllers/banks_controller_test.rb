...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { id_usuario_mod: @bank.id_usuario_mod, id_usuario_reg: @bank.id_usuario_reg, nombre: @bank.nombre } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { id_usuario_mod: @bank.id_usuario_mod, id_usuario_reg: @bank.id_usuario_reg, nombre: @bank.nombre } }
