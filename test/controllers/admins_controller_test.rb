...
class AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin" do
    assert_difference('Admin.count') do
      post admins_url, params: { admin: { contenido: @admin.contenido, titulo: @admin.titulo } }
    end
  ...
  test "should update admin" do
    patch admin_url(@admin), params: { admin: { contenido: @admin.contenido, titulo: @admin.titulo } }
